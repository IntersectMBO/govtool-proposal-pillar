...
import { getAllCurrencies, getNationalityList, getCountryList,getContractTypeList,getBudgetDiscussionRoadMapList,getBudgetDiscussionIntersectCommittee,getBudgetDiscussionTypes } from '../../../lib/api';
        ...
        const fetchData = async () => {
            try {
                ...
                if (!allContractTypeList.length) {
                    const allContractTypeListResponse = await getContractTypeList();
                    setAllContractTypeList(allContractTypeListResponse?.data || []);
                }
                                ...
                                <Box color={(theme) => theme.palette.text.grey}>
                                    ...
                                    <Box sx={{align: "left"}} >
                                        ...
                                        <Typography variant='h6' gutterBottom>
                                            {currentBudgetDiscussionData?.bd_contact_information?.be_full_name || ''}
                                        </Typography>
                                        <Typography variant='body' gutterBottom>
                                            Beneficiary e-mail
                                        </Typography>
                                        <Typography variant='h6' gutterBottom>
                                            {currentBudgetDiscussionData?.bd_contact_information?.be_email || ''}
                                        </Typography><Typography variant='body' gutterBottom>
                                            Beneficiary Country of Residence
                                        </Typography>
                                        <Typography variant='h6' gutterBottom>
                                            {allCountries.find(country => country.id === currentBudgetDiscussionData?.bd_contact_information?.be_country_of_res)?.attributes?.country_name || 'Error'}
                                        </Typography><Typography variant='body' gutterBottom>
                                        ...
                                        <Typography variant='h6' gutterBottom>
                                            {currentBudgetDiscussionData?.bd_contact_information?.submission_lead_full_name || ''}
                                        </Typography>
                                        <Typography variant='body' gutterBottom>
                                            Submission Lead Email
                                        </Typography>
                                        <Typography variant='h6' gutterBottom>
                                            {currentBudgetDiscussionData?.bd_contact_information?.submission_lead_email || ''}
                                        </Typography>
                                    </Box>
                                    <Box sx={{align: "left"}} >
                                        <Typography variant='h4' gutterBottom sx={{align:"left"}}>
                                        ...
                                        <Typography variant='h6' gutterBottom>
                                           {currentBudgetDiscussionData?.bd_proposal_ownership?.submited_on_behalf}
                                        </Typography>
                                        ...
                                        (
                                            <Box>
                                                ...
                                                <Typography variant='h6' gutterBottom>
                                                    {currentBudgetDiscussionData?.bd_proposal_ownership?.company_name || ''}
                                                </Typography>
                                                <Typography variant='body' gutterBottom>
                                                    Company Domain Name
                                                </Typography>
                                                <Typography variant='h6' gutterBottom>
                                                    {currentBudgetDiscussionData?.bd_proposal_ownership?.company_domain_name || ''}
                                                </Typography>
                                                <Typography variant='body' gutterBottom>
                                                    Country of Incorporation
                                                </Typography>
                                                <Typography variant='h6' gutterBottom>
                                                    {allCountries.find(country => country.id === currentBudgetDiscussionData?.bd_proposal_ownership?.be_country)?.attributes?.country_name || 'Error'}
                                                </Typography>
                                            </Box>                                            
                                        ):''}
                                        ...
                                        (
                                            <Box>
                                                ...
                                                <Typography variant='h6' gutterBottom>
                                                    {currentBudgetDiscussionData?.bd_proposal_ownership?.group_name || ''}
                                                </Typography>
                                                <Typography variant='body' gutterBottom>
                                                    Type of Group
                                                </Typography>
                                                <Typography variant='h6' gutterBottom>
                                                    {currentBudgetDiscussionData?.bd_proposal_ownership?.type_of_group || ''}
                                                </Typography>
                                                <Typography variant='body' gutterBottom>
                                                    Key Information to Identify Group
                                                </Typography>
                                                <Typography variant='h6' gutterBottom>
                                                    {currentBudgetDiscussionData?.bd_proposal_ownership?.key_info_to_identify_group || ''}
                                                </Typography>
                                            </Box>
                                        ):''}    
                                        <Typography variant='body' gutterBottom>
                                        ...
                                        <Typography variant='h6' gutterBottom>
                                            {currentBudgetDiscussionData?.bd_proposal_ownership?.proposal_public_champion || ''}
                                        </Typography>
                                        <Typography variant='body' gutterBottom>
                                            What social handles would you like to be used? E.g. Github, X
                                        </Typography>
                                        <Typography variant='h6' gutterBottom>
                                            {currentBudgetDiscussionData?.bd_proposal_ownership?.social_handles || ''}
                                        </Typography>
                                    </Box>
                                    <Box sx={{align: "left"}} >
                                        <Typography variant='h4' gutterBottom sx={{align:"left"}}>
                                        ...
                                        <Typography variant='h6' gutterBottom>
                                            {currentBudgetDiscussionData?.bd_psapb?.problem_statement || ''}
                                        </Typography>
                                        <Typography variant='body' gutterBottom>
                                            Proposal Benefit
                                        </Typography>
                                        <Typography variant='h6' gutterBottom>
                                            {currentBudgetDiscussionData?.bd_psapb?.proposal_benefit || ''}
                                        </Typography>
                                        <Typography variant='body' gutterBottom>
                                            Does this proposal align to the Product Roadmap and Roadmap Goals?
                                        </Typography>
                                        <Typography variant='h6' gutterBottom>
                                            {allRoadMaps.find(rm => rm.id === currentBudgetDiscussionData?.bd_psapb?.roadmap_name)?.attributes?.roadmap_name || 'Error'}
                                        </Typography>
                                        <Typography variant='body' gutterBottom>
                                            Does your proposal align to any of the budget categories?
                                        </Typography>
                                        <Typography variant='h6' gutterBottom>
                                            {allBDTypes.find(bt => bt.id === currentBudgetDiscussionData?.bd_psapb?.type_name)?.attributes?.type_name || 'Error'}
                                        </Typography>
                                        <Typography variant='body' gutterBottom>
                                            Does your proposal align with any of the Intersect Committees?
                                        </Typography>
                                        <Typography variant='h6' gutterBottom>
                                            {allCommittees.find(co => co.id === currentBudgetDiscussionData?.bd_psapb?.committee_name)?.attributes?.committee_name || 'Error'}
                                        </Typography>
                                        <Typography variant='body' gutterBottom>
                                            If possible provide evidence of wider community endorsement for this proposal?
                                        </Typography>
                                        <Typography variant='h6' gutterBottom>
                                            {currentBudgetDiscussionData?.bd_psapb?.supplementary_endorsement || ''}
                                        </Typography>
                                    </Box>
                                    <Box sx={{align: "left"}} >
                                        <Typography variant='h4' gutterBottom sx={{align:"left"}}>
                                    ...
                                    <Box sx={{align: "left"}} >
                                        ...
                                        <Typography variant='h6' gutterBottom>
                                            {currentBudgetDiscussionData?.bd_costing?.ada_amount || ''}
                                        </Typography>
                                        <Typography variant='body' gutterBottom>
                                            ADA to USD Conversion Rate
                                        </Typography>
                                        <Typography variant='h6' gutterBottom>
                                            {currentBudgetDiscussionData?.bd_costing?.usd_to_ada_conversion_rate || ''}
                                        </Typography>
                                        <Typography variant='body' gutterBottom>
                                            Preferred currency
                                        </Typography>
                                        <Typography variant='h6' gutterBottom>
                                            {allCurrencyList.find(co => co.id === currentBudgetDiscussionData?.bd_costing?.preferred_currency)?.attributes?.currency_letter_code || 'Error'}
                                        </Typography>
                                        <Typography variant='body' gutterBottom>
                                            Amount in preferred currency
                                        </Typography>
                                        <Typography variant='h6' gutterBottom>
                                            {currentBudgetDiscussionData?.bd_costing?.amount_in_preferred_currency || ''}
                                        </Typography>
                                        <Typography variant='body' gutterBottom>
                                            Cost breakdown
                                        </Typography>
                                        <Typography variant='h6' gutterBottom>
                                            {currentBudgetDiscussionData?.bd_costing?.cost_breakdown || ''}
                                        </Typography>
                                    </Box>
                                    <Box sx={{align: "left"}} >
                                        <Typography variant='h4' gutterBottom sx={{align:"left"}}>
                                        ...
                                        {currentBudgetDiscussionData.bd_further_information?.proposal_links?.map((link, index) => (
                                            <Link 
                                                key={index}
                                                href={link.prop_link} 
                                                target="_blank" 
                                    ...
                                    <Box sx={{align: "left"}} >
                                        ...
                                        <Typography variant='h6' gutterBottom>
                                            {currentBudgetDiscussionData?.itersect_named_administrator?'Yes':'No'}
                                        </Typography>
                                    </Box>
                                </Box>
                            </Box>
